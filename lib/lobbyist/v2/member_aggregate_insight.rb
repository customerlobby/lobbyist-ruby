module Lobbyist
  module V2
    ...
    class MemberAggregateInsight < Lobbyist::V2::Base
      ...
      attr_accessor :ltv, :recommended_credits, :credit_calculation_status, :customer_contact_info_distribution  
      attr_accessor :created_at, :updated_at, :avg_num_of_visits
