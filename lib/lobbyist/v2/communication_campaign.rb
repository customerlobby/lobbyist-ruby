  ...
  module V2
    ...
    class CommunicationCampaign < Lobbyist::V2::Base
      attr_accessor :id, :company_id, :name, :description, :cost_per_postcard, :threshold, :approved_credits, :recommended_credits, :minimum_roi,
        ...
        :mail_delay_offset, :send_followup_email, :send_sample_postcard, :completed, :in_progress, :iterations_count, :response_rate, :filter_id, :frequency_per_year, :target_mail_date
