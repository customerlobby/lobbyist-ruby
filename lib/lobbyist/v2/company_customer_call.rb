  ...
  module V2
    ...
    class CompanyCustomerCall < Lobbyist::V2::Base
      ...
      def self.list(company_id, params = {})
        create_collection_from_response(get("/v2/companies/#{company_id}/company_customer_calls.json", params))
      end

      def self.create(company_id, params = {})
        create_from_response(post("/v2/companies/#{company_id}/company_customer_calls.json", {'customer_call' => params}))
      end

      def self.destroy(company_id, id)
        create_from_response(delete("/v2/companies/#{company_id}/company_customer_calls/#{id}.json"))
      end
    end
