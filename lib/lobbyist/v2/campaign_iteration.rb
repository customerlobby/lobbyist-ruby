module Lobbyist
  module V2
    ...
    class CampaignIteration < Lobbyist::V2::Base
      ...
      attr_accessor :status, :sent_count, :revenue_generated, :roi, :amount_spent
      attr_accessor :budget_snapshot, :credit_snapshot, :created_at, :updated_at, :results_filename
