module Lobbyist
  module V2
    ...
    class CampaignIteration < Lobbyist::V2::Base
      ...
      attr_accessor :status, :sent_count, :revenue_generated, :roi, :amount_spent, :budget_snapshot, :credit_snapshot, :created_at, :updated_at
      ...
      def self.generate_results_file(id, params={})
        post("v2/campaign-iterations/#{id}/generate-file.json", params)
      end
    end
