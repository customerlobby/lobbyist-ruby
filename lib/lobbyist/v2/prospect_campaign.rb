module Lobbyist
  module V2
    ...
    class ProspectCampaign < Lobbyist::V2::Base
      ...
      attr_accessor :results, :budget_per_month, :cost_per_prospect, :cost_per_sale, :cost_per_acquisition, :vars, :front_logo, :qr_code
      ...
      def self.destroy(id)
        create_from_response(delete("/v2/prospect_campaigns/#{id}.json"))
      end
    end
