module Lobbyist
  class CompanySubscription < Lobbyist::Base
    ...
    attr_accessor :monthly_fee, :setup_fee, :cost_per_postcard, :customer_count_lower_bound, :customer_count_upper_bound, :add_ons
    attr_accessor :email_add_ons, :prospect_add_ons, :cost_per_magnet_mailer
